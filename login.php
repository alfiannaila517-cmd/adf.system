    ...
    <style>
        ...
        * {
        ...
        .login-container {
            ...
            padding: 1.25rem 1.25rem 1.25rem 8vw;
            position: relative;
            overflow: hidden;
        ...
        .login-box {
            background: linear-gradient(170deg, rgba(9, 13, 28, 0.86), rgba(6, 9, 20, 0.9));
            ...
            box-shadow: 0 34px 90px rgba(0, 2, 12, 0.75), inset 0 1px 0 rgba(255, 255, 255, 0.07);
        }
