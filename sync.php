...
$filesToSync = [
    ...
    'modules/frontdesk/rental-mobil.php',
    'modules/frontdesk/rental-mobil-dashboard.php',
    'api/get-checkout-bills.php',
    ...
    'modules/frontdesk/breakfast.php',
    'modules/frontdesk/laporan.php',
    'modules/frontdesk/export-daily-report.php',
