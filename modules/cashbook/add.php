...
<script>
    ...
    // NOTE: Setor Tunai modal functions (showSetorTunaiModal, closeSetorTunaiModal,
    // openAddBankAccountModal, saveQuickAccount, cancelQuickAccount,
    // refreshBankAccountDropdown, submitSetorTunai, Escape/Enter key handlers) are
    // defined ONCE, earlier in this file inside the IIFE right after the
    // "Setor Tunai ke Rekening Bank" modal HTML. A duplicate (and buggy) copy of
    // all of these used to live here and, because it loaded later, silently
    // overrode the working versions above - its submitSetorTunai() grabbed the
    // wrong <form> via document.querySelector('form') (it matched the hidden
    // topbar avatar-upload form from header.php instead of #transactionForm),
    // throwing "Cannot set properties of undefined (setting 'value')" and
    // making the "Setor Tunai" button appear unresponsive. Do NOT re-add a
    // second definition of these functions here.
