...
if (!$customerId) { echo 'Select a customer first.'; exit; }
...
$statusColors = ['draft'=>'#78716C','on_progress'=>'#C2410C','qc'=>'#6D28D9','ready_ship'=>'#15803D','shipped'=>'#047857','completed'=>'#166534','cancelled'=>'#991B1B'];
  ...
  <table class="rpt-table">
    ...
    <tbody>
      <?php foreach ($orders as $ord):
        $color = $statusColors[$ord['status']] ?? '#777';
      ...
      ?>
        <tr>
          ...
          <td>
            ...
            <div style="font-size:10px;color:#777;margin-top:2px"><?= htmlspecialchars(mb_substr($ord['specification'], 0, 80)) ?><?= mb_strlen($ord['specification']) > 80 ? '…' : '' ?></div>
            <?php endif; ?>
          </td>
