        ...
        <div class="card-section">
            ...
            <?php if (!empty($allTransactions)): ?>
                <div class="table-summary">
                    <div class="ts-item">
                        <div class="ts-label">Total Transaksi</div>
                        <div class="ts-value" style="color:var(--text-primary)"><?php echo count($allTransactions); ?> trx</div>
                    </div>
                    <div class="ts-item">
                        <div class="ts-label">Uang Masuk</div>
                        <div class="ts-value" style="color:var(--emerald)">Rp <?php echo number_format($totalCapitalInjected, 0, ',', '.'); ?></div>
                    </div>
                    <div class="ts-item">
                        <div class="ts-label">Uang Keluar</div>
                        <div class="ts-value" style="color:#f87171">Rp <?php echo number_format($totalCapitalUsed, 0, ',', '.'); ?></div>
                    </div>
                    <div class="ts-item">
                        <div class="ts-label">Selisih</div>
                        <div class="ts-value" style="color:<?php echo ($totalCapitalInjected - $totalCapitalUsed) >= 0 ? 'var(--emerald)' : '#f87171'; ?>">Rp <?php echo number_format($totalCapitalInjected - $totalCapitalUsed, 0, ',', '.'); ?></div>
                    </div>
                </div>
        ...
        <div class="card-section">
            ...
            <?php if (!empty($pettyCashTransactions)): ?>
                <div class="table-summary">
                    <div class="ts-item">
                        <div class="ts-label">Total Transaksi</div>
                        <div class="ts-value" style="color:var(--text-primary)"><?php echo count($pettyCashTransactions); ?> trx</div>
                    </div>
                    <div class="ts-item">
                        <div class="ts-label">Uang Masuk</div>
                        <div class="ts-value" style="color:var(--emerald)">Rp <?php echo number_format($totalPettyCashReceived, 0, ',', '.'); ?></div>
                    </div>
                    <div class="ts-item">
                        <div class="ts-label">Uang Keluar</div>
                        <div class="ts-value" style="color:#f87171">Rp <?php echo number_format($totalPettyCashUsed, 0, ',', '.'); ?></div>
                    </div>
                    <div class="ts-item">
                        <div class="ts-label">Balance</div>
                        <div class="ts-value" style="color:<?php echo ($totalPettyCashReceived - $totalPettyCashUsed) >= 0 ? 'var(--emerald)' : '#f87171'; ?>">Rp <?php echo number_format($totalPettyCashReceived - $totalPettyCashUsed, 0, ',', '.'); ?></div>
                    </div>
                </div>
                <div class="table-wrap">
                    <table class="trx-table">
