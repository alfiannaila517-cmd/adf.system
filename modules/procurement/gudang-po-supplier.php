        ...
        <table class="table">
            ...
            <tbody>
                <?php if (empty($gudangPOs)): ?>
                    <tr><td colspan="7" style="text-align:center; padding:2.5rem; color:var(--text-muted);">Belum ada PO supplier. Klik "Buat PO Baru" untuk mulai.</td></tr>
                <?php else: ?>
    ...
    <div class="card" style="width:min(760px,100%); max-height:92vh; overflow:auto;">
        ...
        <form method="POST">
            ...
            <div style="margin-bottom:0.75rem;">
                ...
                <div class="table-responsive">
                    <table class="table" style="font-size:0.875rem;">
                        <thead><tr><th>Nama Item</th><th>Qty</th><th>Unit</th><th>Harga Satuan</th><th></th></tr></thead>
                        <tbody id="itemsBody">
                            <tr>
